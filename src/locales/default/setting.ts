...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'a2a.avatar.label': 'Icon',
  'a2a.avatar.placeholder': 'Emoji or icon URL',
  'a2a.capabilities.desc': 'Capabilities this agent provides (e.g. ffmpeg, 剪映, docker)',
  'a2a.capabilities.label': 'Capabilities',
  'a2a.capabilities.placeholder': 'Type and press Enter to add',
  'a2a.capabilities.required': 'Please add at least one capability tag',
  'a2a.delete': 'Delete',
  'a2a.deleteConfirm': 'Are you sure you want to delete this A2A Agent?',
  'a2a.deleteTitle': 'Delete A2A Agent',
  'a2a.desc': 'Manage A2A Agents for accessing local or remote software and hardware resources',
  'a2a.description.label': 'Description',
  'a2a.description.placeholder': 'Describe the purpose of this Agent',
  'a2a.edit': 'Edit',
  'a2a.editTitle': 'Edit A2A Agent',
  'a2a.endpoint.desc': 'A2A service address (LAN or public internet)',
  'a2a.endpoint.invalid': 'Please enter a valid URL',
  'a2a.endpoint.label': 'A2A Endpoint',
  'a2a.endpoint.placeholder': 'http://192.168.1.100:8080 or https://agent.example.com',
  'a2a.endpoint.required': 'Please enter A2A endpoint',
  'a2a.emptyDesc': 'Click the button above to add an A2A Agent',
  'a2a.name.invalid': 'Only letters, numbers, hyphens and underscores',
  'a2a.name.label': 'Name',
