...
export interface GroupOfficialToolItem {
  ...
  /** Tool display name */
  name: string;
  /** Tool type: 'builtin' for built-in tools, 'composio' for LobeHub Mcp servers, 'lobehub-skill' for LobeHub Skill providers, 'a2a' for A2A agents */
  type: 'builtin' | 'composio' | 'lobehub-skill' | 'a2a';
}
