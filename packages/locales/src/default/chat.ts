export default {
  ...
  'team.defaultTitle': 'New Team',
  'team.tabs.chat': 'Conversation',
  'team.tabs.kanban': 'Tasks',
  'team.tabs.timeline': 'Timeline',
  'team.kanban.noTasks': 'No tasks in this column',
  'team.timeline.noEvents': 'Waiting for team activity...',
  'team.builder.title': '创建助手团队',
  'team.builder.hostHint': '将由助理构建专家自动构建项目负责人，并组建团队',
  'team.builder.requirementLabel': '团队需求',
  'team.builder.requirementPlaceholder': '描述你希望团队完成什么任务，例如：开发一个电商平台...',
  'team.builder.submit': '开始构建',
  'team.builder.cancel': '取消',
  ...
  'heteroAgent.executionTarget.autoDesc': 'Use any available connected device automatically',
  'heteroAgent.executionTarget.autoUnavailableDesc': 'No connected device is online yet',
  'heteroAgent.executionTarget.infoTooltip':
    'Choose where the agent runs. Connected devices use configured folders, terminal access, and command-line tools installed on that device; Cloud Sandbox runs in an isolated temporary cloud environment.',
  ...
  'heteroAgent.executionTarget.noneDesc': "Don't use a connected device or Cloud Sandbox",
  ...
  'heteroAgent.executionTarget.sandboxDesc': 'Run in an isolated temporary cloud environment',
